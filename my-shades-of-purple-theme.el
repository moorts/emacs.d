...
(defgroup my-shades-of-purple-theme nil
  "Options for the `my-shades-of-purple' theme."
  :group 'doom-themes)

(defcustom my-shades-of-purple-padded-modeline doom-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line.
Can be an integer to determine the exact padding."
  :group 'my-shades-of-purple-theme
...
(def-doom-theme my-shades-of-purple
  ...
  ((bg         '("#2d2b55" "#2d2b55"  "black"))
   ...
   (-modeline-pad
    (when my-shades-of-purple-padded-modeline
      (if (integerp my-shades-of-purple-padded-modeline) my-shades-of-purple-padded-modeline 4))))
  ...
  (;;;; emacs
   ...
   ((org-block-begin-line &override) :background base3)
   ;;;; rjsx-mode
...
;;; my-shades-of-purple-theme.el ends here
